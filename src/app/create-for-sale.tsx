      ...
      return (
        <View style={[stylesheet.successContainer, { backgroundColor: theme.colors.DARK }]}>
          ...
          <Text style={stylesheet.successDesc}>
            Your listing was flagged and has been sent for admin review. It will appear on the feed
            once approved.
          </Text>
          <TouchableOpacity
      ...
      >
        {step === 0 && (
          <View>
            ...
            <Text style={stylesheet.stepDesc}>
              First item becomes your listing cover. At least one image is required.
            </Text>
          ...
          <View style={stylesheet.formGroup}>
            ...
            <View style={{ flexDirection: 'row', gap: 12, marginBottom: 16 }}>
              <TouchableOpacity
                style={[
                  stylesheet.chip,
                  listingType === 'For Sale' && stylesheet.chipActive,
              ...
              >
                <Text
                  style={[
                    stylesheet.chipText,
                    listingType === 'For Sale' && stylesheet.chipTextActive,
                  ]}
                >
                  Selling
                </Text>
              ...
              <TouchableOpacity
                style={[
                  stylesheet.chip,
                  listingType === 'Giveaway' && stylesheet.chipActive,
                  { flex: 1, alignItems: 'center' },
                ]}
                onPress={() => {
              ...
              >
                <Text
                  style={[
                    stylesheet.chipText,
                    listingType === 'Giveaway' && stylesheet.chipTextActive,
                  ]}
                >
                  Giveaway
                </Text>
                ...
                {categories.map((cat) => (
                  ...
                  >
                    <Text
                      style={[
                        stylesheet.chipText,
                        category === cat.name && stylesheet.chipTextActive,
                      ]}
                    >
                      {cat.name}
                    </Text>
            ...
            <View style={stylesheet.conditionList}>
              {CONDITIONS.map((cond) => (
                <TouchableOpacity
                  key={cond}
                  style={[
                    stylesheet.conditionRow,
                    condition === cond && stylesheet.conditionRowActive,
                  ]}
                  onPress={() => setCondition(cond)}
                >
                  <View
                    style={[
                      stylesheet.radioCircle,
                      condition === cond && stylesheet.radioCircleActive,
                    ]}
                  >
                  ...
                  <Text
                    style={[
                      stylesheet.conditionText,
                      condition === cond && stylesheet.conditionTextActive,
                    ]}
                  >
                    {cond}
                  </Text>
        ...
        {step === 2 && (
          <View style={stylesheet.formGroup}>
            ...
            <Text style={stylesheet.stepDesc}>
              Describe condition, size, features, and pickup info.
            </Text>
        ...
        {step === 3 && (
          <View style={stylesheet.formGroup}>
            ...
            <Text style={stylesheet.stepDesc}>
              Make sure everything looks accurate before posting.
            </Text>
            ...
            >
              ...
              <View style={{ padding: 16 }}>
                ...
                <View style={{ flexDirection: 'row', flexWrap: 'wrap', gap: 8, marginBottom: 16 }}>
                  ...
                  >
                    <Text style={{ fontFamily: 'Inter-Medium', color: '#ccc', fontSize: 13 }}>
                      {condition || 'Used'}
                    </Text>
                  </View>
                  <View
                ...
                >
                  ...
                  <Text
                    style={{ fontFamily: 'Inter-Regular', color: theme.colors.LABEL, fontSize: 14 }}
                  >
